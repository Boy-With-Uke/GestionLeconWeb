  ...
  return (
    <NavigationMenu>
      <NavigationMenuList>
        ...
        <NavigationMenuItem>
          <NavigationMenuTrigger>Commencer a etudier</NavigationMenuTrigger>
          <NavigationMenuContent>
              ...
              <li className="row-span-3">
                <NavigationMenuLink asChild>
                  ...
                  >
                    ...
                    <div
                      className="mb-2 mt-Beautifully designed components that you can copy and
                      paste into your apps. Accessible. Customizable. Open
                      Source.4 text-lg font-medium"
                    >
                      E-hanatra
                    </div>
